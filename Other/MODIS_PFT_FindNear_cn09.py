...
grid_nc  = "GRIDCRO2D_2000121_GuangDongD2" # CMAQ 网格（.nc 或无后缀均可）
YEAR     = 2000
hlines  = [26, 27, 28, 29]               # 横向瓦片
vlines  = [5, 6, 7]                           # 纵向瓦片
exclude_tiles = set()                      # 例如 {"h30v06"}
SIDE_M   = 9000.0                          # 正方形边长（米）
HALF_M   = SIDE_M / 2.0
...
out_nc   = f"PFT_frac_{YEAR}_9km_square.nc"
out_csv  = f"PFT_frac_{YEAR}_9km_square.csv"

skip_tiles = ["h26v07", "h29v05"]  # 你可以随时修改
